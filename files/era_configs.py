...
ERA_CONFIGS = {
    ...
    'era21': {
        'description': 'Pure Era 2 Revival: wide gates (5-55c), signal direction, conviction Kelly. Paper first.',
        'CRYPTO_15MIN_SERIES': ['KXBTC15M', 'KXETH15M', 'KXSOL15M', 'KXXRP15M'],
        'YES_ONLY_MODE': False,
        'CHEAP_SIDE_MODE': False,
        'SIGNAL_VETO_ENABLED': False,
        'MAX_SPREAD': 0,
        'MIN_ENTRY_PRICE': 5,
        'MAX_ENTRY_PRICE': 55,
        ...
        'REGIME_GATE_ENABLED': False,
        'OBSERVATION_MODE': True,
        'NOTE': 'Back to basics. Era 2 was +$46.80 at 47.3% WR. Signal-based direction, conviction Kelly sizing, wide open gates.',
    },
}
